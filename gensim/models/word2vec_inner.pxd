...
cdef void w2v_fast_sentence_sg_hs(
    ...
    const np.uint32_t word2_index, const np.float64_t *alpha, REAL_t *work, REAL_t *word_locks,
...
cdef unsigned long long w2v_fast_sentence_sg_neg(
    ...
    const np.uint32_t word2_index, const np.float64_t *alpha, REAL_t *work,
...
cdef void w2v_fast_sentence_cbow_hs(
    ...
    const np.uint32_t indexes[MAX_SENTENCE_LEN], const np.float64_t *alpha, REAL_t *work,
